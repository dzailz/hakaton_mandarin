...
if __name__ == '__main__':
    ...
    load_path = path.abspath(path.join(__file__, '../../../data/datasets/SF_Mandarin_dataset_ver4.csv'))
    full_prepared_save_path = path.abspath(path.join(__file__, '../../../data/datasets/prepared_full_exp.parquet'))
